...
/**
 * Componente de card com efeito de borda brilhante
 * Deve ser usado dentro do GlowyCardWrapper para efeitos completos
 * 
 * @param {Object} props
 * @param {React.ReactNode} props.children - Conteúdo do card
 * @param {string} props.className - Classes CSS adicionais
 */
const GlowyCard = ({ children, className = '' }) => {
  return (
    <div 
      className={`w-full h-full rounded-xl overflow-hidden backdrop-blur-sm ${className}`}
      style={{
...
// Inject CSS for the GlowyCard component
const styles = `
...
// Creating a style tag to inject our CSS
