...
export default function Demo() {
  ...
  const [activeTab, setActiveTab] = useState('chat'); // 'chat' ou 'info'
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-stretch">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
              ...
              <div className="flex mb-4 border-b border-white/10">
                <button 
                  ...
                  className={`px-4 py-2 font-medium relative ${activeTab === 'chat' ? 'text-blue-400' : 'text-neutral-400'}`}
                >
                  Demonstração
                  {activeTab === 'chat' && <span className="absolute bottom-0 left-0 w-full h-0.5 bg-blue-500"></span>}
                </button>
                <button 
                  onClick={() => setActiveTab('info')}
                  className={`px-4 py-2 font-medium relative ${activeTab === 'info' ? 'text-blue-400' : 'text-neutral-400'}`}
                >
                  Recursos
                  {activeTab === 'info' && <span className="absolute bottom-0 left-0 w-full h-0.5 bg-blue-500"></span>}
                </button>
              </div>
                ...
                {activeTab === 'chat' ? (
                  ...
                  >
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        { title: "Respostas IA", value: "97%", subtitle: "precisão" },
                        { title: "Tempo médio", value: "1.2s", subtitle: "resposta" },
                        { title: "Conversão", value: "35%", subtitle: "aumento" },
                        { title: "Satisfação", value: "98%", subtitle: "clientes" }
                      ].map((stat, idx) => (
                        <div key={idx} className="bg-white/5 p-3 rounded-lg">
                          <p className="text-neutral-400 text-xs">{stat.title}</p>
                          <p className="text-xl font-bold text-white">{stat.value}</p>
                          <p className="text-xs text-blue-400">{stat.subtitle}</p>
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-white/10">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="text-sm text-blue-400">Rápida</span>
                      </div>
          ...
          >
            <div className="relative">
              ...
              <GlowyCardWrapper hue={220} size={180} border={2} radius={16}>
                <GlowyCard>
