          ...
          <GlowyCard>
            <div className="bg-white/95 rounded-2xl p-12 transition-all duration-300">
              <div className="text-center mb-12">
                ...
                />
                <h1 className="text-5xl md:text-6xl font-extrabold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent drop-shadow-sm">Política de Privacidade</h1>
              </div>
              <p className="text-xl text-gray-700 leading-relaxed max-w-2xl mx-auto">
                Saiba como suas informações são coletadas, usadas e protegidas em nossa plataforma. 
                Valorizamos sua privacidade e estamos comprometidos em garantir a segurança dos seus dados pessoais.
              </p>
              <p className="text-xl text-gray-700 leading-relaxed mt-8 max-w-2xl mx-auto">
                Para mais detalhes, consulte nossa política completa ou entre em contato conosco para esclarecer dúvidas.
              </p>
