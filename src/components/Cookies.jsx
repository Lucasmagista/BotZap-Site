          ...
          <GlowyCard>
            <div className="bg-white/95 rounded-2xl p-12 transition-all duration-300">
              <div className="text-center mb-12">
                ...
                />
                <h1 className="text-5xl md:text-6xl font-extrabold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent drop-shadow-sm">Política de Cookies</h1>
              </div>
              <p className="text-xl text-gray-700 leading-relaxed max-w-2xl mx-auto">
                Entenda como utilizamos cookies para melhorar sua experiência.
                Saiba quais informações coletamos e como você pode gerenciar suas preferências.
              </p>
