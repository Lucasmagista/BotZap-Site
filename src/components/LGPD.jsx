          ...
          <GlowyCard>
            <div className="bg-white/95 rounded-2xl p-12 transition-all duration-300">
              <div className="text-center mb-12">
                <img
                  src="/assets/lgpd-icon.svg"
                  alt="LGPD"
                  className="mx-auto w-24 h-24 mb-8 animate-pulse"
                />
                <h1 className="text-5xl md:text-6xl font-extrabold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent drop-shadow-sm">LGPD</h1>
              </div>
              <p className="text-xl text-gray-700 leading-relaxed max-w-2xl mx-auto">
                Saiba como garantimos a conformidade com a Lei Geral de Proteção de Dados.
                Aqui você encontra informações sobre como seus dados são tratados em nossa plataforma.
              </p>
              <p className="text-xl text-gray-700 leading-relaxed mt-8 max-w-2xl mx-auto">
                Para mais detalhes, consulte nossas políticas completas ou entre em contato conosco para esclarecer dúvidas.
              </p>
